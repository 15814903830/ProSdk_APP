...
public abstract class BaseRVAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    /**
     * if setHeadView will be myreturn 1 if not will be myreturn 0.
    ...
    /**
     * if mFooterLayout will be myreturn 1 or not will be myreturn 0.
    ...
    /**
     * if addHeaderView will be myreturn 1, if not will be myreturn 0
     */
    ...
    /**
     * if addFooterView will be myreturn 1, if not will be myreturn 0
     */
    ...
    /**
     * if show empty view will be myreturn 1 or not will be myreturn 0
     *
     * @return
     */
...
//            subItemCount += list.size();
     ...
     *
     * @return myreturn the closest parent item position of the IExpandable.
     * if the IExpandable item's level is 0, myreturn itself position.
     * if the item's level is negative which mean do not implement this, myreturn a negative
     * if the item is not exist in the data list, myreturn a negative.
     */
    public int getParentPosition(@NonNull T item) {
        ...
        // if the item is IExpandable, myreturn a closest IExpandable item position whose level smaller than this.
        // if it is not, myreturn the closest IExpandable item position whose level is not negative
        int level;
